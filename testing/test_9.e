note
	...
	date: "$Date: 2023-04-05 12:15:59 -0300 (Wed, 05 Apr 2023) $"
	revision: "$Revision: 106729 $"
...
--			l_method.add_instruction (create {CIL_INSTRUCTION}.make ({CIL_INSTRUCTION_OPCODES}.i_ret, Void))
			...
			pe_file.dump_output_file ("test_define_assembly_obj.dll", {CIL_OUTPUT_MODE}.pedll, false)
